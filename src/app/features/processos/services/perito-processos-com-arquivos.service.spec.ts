...
import { PeritoProcessosComArquivosService } from './perito-processos-com-arquivos.service';
import { ProcessoPastaResumoApi } from './processo-pasta-resumo.model';

const URL = `${environment.apiBaseUrl}/peritos/9/pastas-perito/processos`;

describe('PeritoProcessosComArquivosService', () => {
  let service: PeritoProcessosComArquivosService;
  let http: HttpTestingController;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideHttpClient(), provideHttpClientTesting(), PeritoProcessosComArquivosService],
    });
    service = TestBed.inject(PeritoProcessosComArquivosService);
    http = TestBed.inject(HttpTestingController);
  });

  afterEach(() => http.verify());

  it('busca a lista do perito certo e mapeia a contagem (pastas/documentos/tamanho) sem perder valor', () => {
    const linha: ProcessoPastaResumoApi = {
      processo_id: 1,
      numero_processo: '5001234-88.2026.4.05.8100',
